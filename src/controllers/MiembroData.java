...
public class MiembroData {
    ...
    /**
     * Metodo para listar los miembros de una bd donde el estado sea activo; al listar sin recibir parametros, obtengo un array para su posterior uso en un comboBox en las vistas.
     *
    ...
    /**
     * Metodo para insertar/agregar un miembro a la bd usando una consulta parametrizada.
     *
    ...
    /**
     * Metodo para actualizar un miembro en la bd con este metodo se puede actualizar cuaquier campo y volver a guardar en el mismo objeto de tipo miembro
     *
     * @param miembro
     * @
     */
     ...
     * @return devuelve un true si lo encuentra o false si no lo encuentra y permite realizar un insert.
     */
